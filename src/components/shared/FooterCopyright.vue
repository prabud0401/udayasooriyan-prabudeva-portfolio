...
export default {
	data: () => {
		return {
			...
			projectName: 'D PrabuDs Portfolio Showcase',
			author: 'Udayasooriyan Prabudeva',
		};
	},
};
</script>
...
<template>
	<div class="flex justify-center items-center text-center">
		...
		>
			&copy; {{ copyrightDate }}.
			<a
				href="https://github.com/prabud0401/udayasooriyan-prabudeva-portfolio"
				target="__blank"
			...
			. Developed by
			<a
				href="https://github.com/prabud0401"
				target="__blank"
